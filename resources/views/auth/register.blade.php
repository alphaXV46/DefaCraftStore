    ...
    <div class="auth-card">
        ...
        <div class="auth-card-body">
            ...
            <div class="social-login">
                <button type="button" class="btn-social" onclick="alert('Fitur Google Login segera hadir!')">
                ...
                <button type="button" class="btn-social" onclick="alert('Fitur Facebook Login segera hadir!')">
