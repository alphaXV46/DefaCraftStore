                        ...
                        <div class="accordion-item border-0 mb-3 rounded shadow-sm">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button fw-bold collapsed bg-white rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                    Apakah produk yang dijual 100% handmade?
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                <div class="accordion-body text-muted">
                                    Ya, seluruh produk di DefaCraftStore dirakit dan dibuat secara manual (handmade) dengan penuh ketelitian untuk memastikan kualitas terbaik pada setiap detailnya.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0 mb-3 rounded shadow-sm">
                            <h2 class="accordion-header" id="headingThree">
                                <button class="accordion-button fw-bold collapsed bg-white rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    Apakah saya bisa memesan produk custom / warna khusus?
                                </button>
                            </h2>
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                <div class="accordion-body text-muted">
                                    Tentu saja! Untuk pemesanan custom (seperti ukuran, ukiran nama, atau kombinasi warna tertentu), Anda bisa langsung menghubungi kami melalui WhatsApp atau email yang tertera di halaman Kontak Kami untuk diskusi lebih lanjut.
                                </div>
                            </div>
                        </div>
