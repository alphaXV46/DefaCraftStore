...
<script>
    // Bungkus semua dalam DOMContentLoaded agar aman
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Inisialisasi modal HANYA saat dibutuhkan (Lazy Init)
        let cropperModal;
        ...
        cropperModalElement.addEventListener('hidden.bs.modal', function() {
            ...
            // Reset input file agar bisa pilih file yang sama lagi jika batal
            imageInput.value = "";
        });

        // 4. Eksekusi Potong Gambar
