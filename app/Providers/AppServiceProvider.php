...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // JURUS BUNGLON: Sesuaikan public_path antara local (Laragon) dan production (cPanel public_html)
    ...
    public function boot(): void
    {
        ...
        if ($host) {
            if (str_contains($host, 'ngrok-free.dev') || str_contains($host, 'defacraftstore.biz.id') || app()->environment('production')) {
